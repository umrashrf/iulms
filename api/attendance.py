...
def get_attendance(session):
    ...
    for tr in trs:
        ...
        sessions = get_first(tr.xpath('td[2 and contains(@class, "attendanceRowStat")]/text()')).strip()
        presents = get_first(tr.xpath('td[3 and contains(@class, "attendanceRowStat")]/text()')).strip()
        absents = get_first(tr.xpath('td[4 and contains(@class, "attendanceRowStat")]/text()')).strip()
