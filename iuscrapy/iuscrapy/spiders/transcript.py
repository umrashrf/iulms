...
class Transcript(Login):
    ...
    def scrape(self, response):
        return Request('http://iulms.edu.pk/sic/Transcript.php', callback=self.goto_transcripts)

    def goto_transcripts(self, response):
        ...
        for degree in degrees:
            ...
            yield FormRequest('http://iulms.edu.pk/sic/SICDataService.php', callback=self.scrape_transcript,
                    formdata={
    ...
    def scrape_transcript(self, response):
